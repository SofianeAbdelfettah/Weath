...
/**
 * Created by Yunori on 05/05/2016.
 */
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public ViewAnimator(Activity activity, List<T> items, Context cont, final DrawerLayout drawerLayout, ViewAnimatorListener animatorListener){
    ...
    private void switchItem(Resourceble slideMenuItem, int topPosition) {
        ...
        if(slideMenuItem.getName() == ContentFragment.MAIN)
            intent = new Intent(context, MainActivity.class);
        else if(slideMenuItem.getName() == ContentFragment.MAINFIVE)
            intent = new Intent(context, GeoFive.class);
        else if(slideMenuItem.getName() == ContentFragment.SEARCH)
            intent = new Intent(context, Search.class);
        else if(slideMenuItem.getName() == ContentFragment.SEARCHFIVE)
            intent = new Intent(context, SearchFive.class);
        else if(slideMenuItem.getName() == ContentFragment.TEMPLATE)
            intent = new Intent(context, ThemePage.class);
